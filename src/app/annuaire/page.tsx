...
type Resident = { id: number; firstName: string; lastName: string; floor: number | null; email: string; avatarUrl: string | null; phone: string | null; bio: string | null; tagline: string | null; senior: boolean; kids: boolean; showFullName: boolean; verified: boolean; coproprietaire: boolean };
...
export default async function AnnuairePage() {
  ...
  if (db) {
    ...
    residents = (fallbackUsers as any[]).map((r: any) => ({ ...r, tagline: r.tagline || null, coproprietaire: false })) as unknown as Resident[];
  }
